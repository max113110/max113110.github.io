			...
			<div class="infoFormPagea">
				<div class="alert alert-warning">
					...
					<div class="bs-callout bs-callout-info">
						Наш магазин создан на основе интернет-сервиса <a href="https://primearea.biz" target="_blank">PRIMEAREA.BIZ</a>. Это означает что вы, как покупатель, сможете воспользоваться выбранным товаром сразу после оплаты. то вы получите набор цифр или отсканированное изображение этого кода. При оплате нет необходимости регистрироваться! Единственное, что от вас потребуется - выбрать наиболее удобный для вас способ оплаты и осуществить покупку. 
					</div>
